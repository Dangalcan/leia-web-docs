...
One you have the proper tools, just install all the repos dependencies and prepare your `.env` files. Check each repo section to understand them better and be concerned about the `.env` variables
